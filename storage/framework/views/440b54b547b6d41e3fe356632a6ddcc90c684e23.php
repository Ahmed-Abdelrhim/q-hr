          ...
          <div class="app-modal-card" data-name="settings" data-modal='0'>
              <form id="update-settings" action="<?php echo e(route('avatar.update')); ?>" enctype="multipart/form-data" method="POST">
                  ...
                  <div class="app-modal-body">
                      ...
                      style="background-image: url('<?php echo e($profile.'/'.Auth::user()->avatar); ?>');"
                      ></div>
...
<?php /**PATH D:\q-sale xampp\htdocs\hr\resources\views/vendor/Chatify/layouts/modals.blade.php ENDPATH**/ ?>