        ...
        <div class="card-body">
            <div class="messenger rounded min-h-750 overflow-hidden">
                ...
                <div class="messenger-listView">
                    ...
                    <div class="<?php if($route == 'user'): ?> show1 <?php endif; ?> messenger-tab app-scroll" data-view="users">
                        ...
                        <nav class="d-flex a;align-items-center justify-content-between">
                            ...
                            <div style="display: flex;">
                                    ...
                                    <?php if(!empty(Auth::user()->avatar)): ?>
                                        <div class="avatar av-s header-avatar" style="margin: 0px 10px; margin-top: -5px; margin-bottom: -5px;background-image: url('<?php echo e(\App\Models\Utility::get_file('uploads/avatar/'.Auth::user()->avatar)); ?>');"></div>
                                    <?php else: ?>
                                        <div class="avatar av-s header-avatar" style="margin: 0px 10px; margin-top: -5px; margin-bottom: -5px;background-image: url('<?php echo e(\App\Models\Utility::get_file('uploads/avatar/avatar.png')); ?>');"></div>
                                    <?php endif; ?>
...
<?php endif; ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\q-sale xampp\htdocs\hr\resources\views/vendor/Chatify/pages/app.blade.php ENDPATH**/ ?>