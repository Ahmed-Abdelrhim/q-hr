                                        ...
                                        <div class="choose-files ">
                                            <label for="profile">
                                                ...
                                                <img id="blah" width="100"
                                                     src="<?php echo e(!empty($userDetail->avatar) ? asset('storage/uploads/avatar') .'/'. $userDetail->avatar : $profile . '/avatar.png'); ?>"/>
                                            </label>
                                        </div>
                                        <span
...
<?php echo $__env->make('layouts.custom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\q-sale xampp\htdocs\hr\resources\views/user/profile.blade.php ENDPATH**/ ?>