                ...
                <div class="card-body ">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            {!! Form::text('start_date', old('start_date'), ['class' => 'form-control d_week', 'autocomplete' => 'off' ,'placeholder'=>'Select start date']) !!}
                        </div>
                        <div class="form-group col-md-6">
                            {!! Form::label('end_date', __('End Date'), ['class' => 'col-form-label']) !!}
                            {!! Form::text('end_date', old('end_date'), ['class' => 'form-control d_week', 'autocomplete' => 'off' ,'placeholder'=>'Select end date']) !!}
                        </div>
                        <div class="form-group col-md-12">
